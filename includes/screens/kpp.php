<div class="wrap">
    ...
    <div class="kpp_block">
        ...
        <div class="kpp_plugin">
            ...
            <span class="description"><?= __("Site details the way you need them", 'smtpkptext') ?></span>
            <span class="links"><a href="<?= admin_url('plugin-install.php?tab=plugin-information&amp;plugin=details-king-pro&amp;TB_iframe=true&amp;width=600&amp;height=550'); ?>" class="thickbox" title="<?= __("More information about", 'smtpkptext') ?> Details King Pro"><?= __("Install", 'smtpkptext') ?></a></span>
        </div>
        <div class="kpp_plugin">
